...
class SliderController extends Controller
{
    ...
    public function store(Request $request)
    {
       ...
       if(isset($image)){
           ...
           if(!file_exists('uploade/slider')){
               mkdir('uploade/slider',0777,true);
           }
           $image->move('uploade/slider',$imageName);
       }else{
    ...
    {
       $slider=Slider::find($id);
       if (file_exists('uploade/slider/'.$slider->image)){
           unlink('uploade/slider/'.$slider->image);
       }
